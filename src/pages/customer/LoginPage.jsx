    ...
    <div style={{ display:'flex', minHeight:'100vh', fontFamily:'Inter, sans-serif' }}>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'40px 24px', background:'#fdf7ff', overflowY:'auto', minHeight:'100vh' }}>
        <div style={{ width:'100%', maxWidth:420 }}>
          ...
          {/* Google */}
          <button type="button" style={{ width:'100%', height:48, display:'flex', alignItems:'center', justifyContent:'center', gap:10, background:'#fff', border:'1px solid #cbc4d2', borderRadius:12, cursor:'pointer', ...T.labelLg, color:'#1d1b20', marginBottom:20, transition:'background .15s' }}
            onMouseEnter={e=>e.currentTarget.style.background='#f8f2fa'} onMouseLeave={e=>e.currentTarget.style.background='#fff'}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:24 }}>
            ...
            <span style={{ ...T.labelMd, color:'#7a7582', textTransform:'uppercase' }}>or use email</span>
            <div style={{ flex:1, height:1, background:'#cbc4d2' }} />
          </div>
          ...
          {mode==='login' && (
            <form onSubmit={loginForm.handleSubmit(onLogin)} style={{ animation:'fade-in .25s ease-out' }}>
              ...
              <div style={{ textAlign:'center', marginTop:16 }}>
                <button type="button" style={{ background:'rgba(79,55,138,0.08)', border:'1px solid #cbc4d2', borderRadius:999, padding:'8px 20px', cursor:'pointer', ...T.bodySm, color:'#4f378a', fontWeight:500 }}>
